...
const sanitizeCssValue = (value: string): string | null => {
  // Allow HSL values like "hsl(220 70% 50%)" or "210 40% 98%"
  // Allow hex colors like "#ff0000" or "#fff"
  // Allow named colors and CSS variable references
  const safePattern = /^(hsl\([^)]*\)|#[0-9A-Fa-f]{3,8}|[a-zA-Z]+|\d[\d.\s%/,]*)$/;
